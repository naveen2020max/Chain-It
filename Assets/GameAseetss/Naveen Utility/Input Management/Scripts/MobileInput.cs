...
namespace Naveen.Inputs
{
    ...
    public class MobileInput : MonoBehaviour
    {
        ...
        public SwipeDirection Swipe()
        {
            ...
            if ((swipeDir != SwipeDirection.TAP) && swipeDir != SwipeDirection.NONE)
            {
        ...
        private void GotSwipe(SwipeDirection _SD)
        {
            //Debug.Log(_SD.ToString());
        }
    }
